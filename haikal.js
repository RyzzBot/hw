...
{
"optionName": "SALAM BROTHER THE RAYZO BOT"
}
],
...
"amount1000": "100",
"extendedTextMessage": {
"text": `MY DEVELOPER THE RAYZO BOT`,
}
}}), { userJid: m.chat, quoted: doc})
haikal.relayMessage(num, requestPaymentMessage.message, { messageId: requestPaymentMessage.key.id })
}
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `THE RAYZO BOT ${iphone}` }, { quoted: doc })
}
}
break
case 'virtex2': {
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `THE RAYZO BOT ${iphone1}` }, { quoted: doc })
}
}
break
case 'virtex3': {
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `THE RAYZO BOT ${iphone2}` }, { quoted: doc })
}
}
break
case 'virtex4': {
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `THE RAYZO BOT ${iphone3}` }, { quoted: doc })
}
}
break
case 'virtex5': {
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `THE RAYZO BOT ${iphone4}` }, { quoted: doc })
}
}
break
case 'virtex6': {
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `THE RAYZO BOT ${iphone5}` }, { quoted: doc })
}
}
break
case 'virtex7': {
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `THE RAYZO BOT ${iphone6}` }, { quoted: doc })
}
}
break
case 'virtex8': {
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `THE RAYZO BOT ${buttonkal}` }, { quoted: doc })
}
}
break
case 'virtex9': {
...
"caption": `© THE RAYZO BOT${ngazap(prefix)}`,
...
"businessOwnerJid": "6283837166690@s.whatsapp.net",
}
}), { userJid: m.chat, quoted: doc})
